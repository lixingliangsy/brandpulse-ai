...
export const PIPELINE_ID = 'brandpulse-ai-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Brand & competitor set",
  process: "Step 2/3 · Probe LLM mention gaps",
  output: "Step 3/3 · Weekly visibility report",
}
