...
export default function Home() {
  ...
  async function runStudio(e?: FormEvent) {
    ...
    try {
      ...
      for (const k of ['commits', 'text', 'article', 'endpoints', 'notes', 'goal', 'topic', 'industry', 'products', 'brand', 'resume', 'jd']) {
        if (!inputMap[k]) inputMap[k] = topic
      }
      // map remaining field keys from form state when present
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://brandpulse-ai.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is BrandPulse?", "acceptedAnswer": {"@type": "Answer", "text": "A GEO tool showing how often LLMs cite your brand across key queries versus competitors."}}, {"@type": "Question", "name": "Which engines?", "acceptedAnswer": {"@type": "Answer", "text": "Multi-LLM tracking across ChatGPT, Perplexity, and Claude."}}, {"@type": "Question", "name": "What is the competitor gap?", "acceptedAnswer": {"@type": "Answer", "text": "A weekly view of queries where rivals get cited and you do not."}}, {"@type": "Question", "name": "Are there alerts?", "acceptedAnswer": {"@type": "Answer", "text": "Pro tier alerts flag shifts in AI-search visibility."}}, {"@type": "Question", "name": "Do I need code?", "acceptedAnswer": {"@type": "Answer", "text": "No. Enter brands and review reports."}}, {"@type": "Question", "name": "Is this a Google rank tracker?", "acceptedAnswer": {"@type": "Answer", "text": "No. It measures LLM citation / answer-engine visibility, not classic SERP positions."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">BrandPulse - definition</h2>
