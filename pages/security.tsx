  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={NAME + " — How BrandPulse handles your data and the compliance posture it maintains."} />
      </Head>
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-slate-600">Enter your brand and a few competitors; see how often leading LLMs mention you across key queries. For growth and marketing leads tracking AI-search visibility (GEO) as buyers shift from Google to LLM answers.</p>
          <h2 className="mt-8 text-xl font-semibold text-slate-900">What we handle</h2>
          <p className="mt-2 text-slate-600">BrandPulse processes the text or configuration you submit to produce its output. We do not train public models on your submissions without explicit consent.</p>
