 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="brandpulse-ai" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "brandpulse-ai";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "brandpulse-ai") + "_chat_session";
